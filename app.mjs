...
async function loadPromos() {
  ...
  const STATE_FILE = resolve(ROOT, 'data/state.json');const LIVE_PROMOS = resolve(ROOT, 'data/promos.live.json');const APPROVED_PROMOS = resolve(ROOT, 'data/promos.approved.json');
